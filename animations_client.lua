...
AddEventHandler("vmenu:Sportives", function(target)
	...
	VMenu.AddFunc(98, "Musculation abdos", "anim:play", {58}, "Valider")
	VMenu.AddFunc(98, "Echauffement", "anim:play", {49}, "Valider")
	VMenu.AddFunc(98, "Muscle", "anim:play", {52}, "Valider")
	VMenu.AddFunc(98, "Musculation bras", "anim:play", {53}, "Valider")
end)
...
AddEventHandler("vmenu:Festives", function(target)
	...
	VMenu.AddFunc(98, "Danser", "anim:play", {66}, "Valider")
	VMenu.AddFunc(98, "Finir bourré", "anim:play", {67}, "Valider")
	VMenu.AddFunc(98, "Fumer un joint", "anim:play", {39}, "Valider")
	VMenu.AddFunc(98, "Fumer un joint v2", "anim:play", {60}, "Valider")
end)
...
AddEventHandler("vmenu:Jobs", function(target)
	...
	VMenu.AddFunc(98, "Porter secours", "anim:play", {84}, "Valider")
	VMenu.AddFunc(98, "Prendre note", "anim:play", {85}, "Valider")
	VMenu.AddFunc(98, "Controle Police", "anim:play", {86}, "Valider")
	VMenu.AddFunc(98, "Attendre Police", "anim:play", {87}, "Valider")
	...
	VMenu.AddFunc(98, "Planter un clou", "anim:play", {45}, "Valider")
	VMenu.AddFunc(98, "Lampe torche", "anim:play", {57}, "Valider") 
	VMenu.AddFunc(98, "Laver vitre", "anim:play", {51}, "Valider")
	VMenu.AddFunc(98, "Attendre balais", "anim:play", {48}, "Valider")
end)
...
AddEventHandler("vmenu:Positions", function(target)
	...
	VMenu.AddFunc(98, "Allonger sur le ventre", "anim:play", {68}, "Valider")
...
AddEventHandler("vmenu:Autres", function(target)
	...
	VMenu.AddFunc(98, "Faire un DAB", "anim:play", {47}, "Valider")
end)
